...
<html lang="zxx">
	<head>
		...
		<!-- Favicon -->
		<link rel="icon" type="image/favicon.png" href="theme/img/favicon.png">
		...
		<!-- Bizwheel Colors -->
		<!--<link rel="stylesheet" href="theme/css/skins/skin-1.css">
		<!--<link rel="stylesheet" href="theme/css/skins/skin-2.css">-->
		<!--<link rel="stylesheet" href="theme/css/skins/skin-3.css">-->
		<!--<link rel="stylesheet" href="theme/css/skins/skin-4.css">-->
	...
	<body id="bg">
		...
		<section class="hero-slider style1">
			<div class="home-slider">
				...
				<div class="single-slider" style="background-image:url('/theme/img/slider/sl1.jpg')">
					<div class="container">
						<div class="row">
...
<!--										<h4>We are always ready to help you</h4>-->
                                                                                <h1 style="color: white; text-shadow: 2px 2px black;">Our Creative Designer Waiting for Projects</h1>
<!--										<div class="p-text">
				...
				<div class="single-slider" style="background-image:url('/theme/img/slider/sl2.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7 col-md-8 col-12">
								<div class="welcome-text"> 
									<div class="hero-text"> 
<!--										<h4>We are always ready to help you</h4>-->
                                                                                <h1 style="color: #F3A712; text-shadow: 2px 2px black;">Our Creative Designer Waiting for Projects</h1>
<!--										<div class="p-text">
											<p>Nunc tincidunt venenatis elit. Etiam venenatis quam vel maximus bibendum Pellentesque elementum dapibus diam tristique</p>
										</div>-->
										<div class="button">
...
<!--				<div class="single-slider" style="background-image:url('https://via.placeholder.com/1700x800.png')">
						...
						<div class="partner-slider">
							...
							<div class="single-slider">
								<div class="single-client">
									<a href="#" target="_blank"><img src="theme/img/client/client-1.png" alt="#"></a>
								</div>
							</div>
							<!--/ End Single client -->
							<!-- Single client -->
							<div class="single-slider">
								<div class="single-client">
									<a href="#" target="_blank"><img src="theme/img/client/client-2.png" alt="#"></a>
								</div>
							</div>
							<!--/ End Single client -->
							<!-- Single client -->
							<div class="single-slider">
								<div class="single-client">
									<a href="#" target="_blank"><img src="theme/img/client/client-3.png" alt="#"></a>
								</div>
							</div>
							<!--/ End Single client -->
							<!-- Single client -->
							<div class="single-slider">
								<div class="single-client">
									<a href="#" target="_blank"><img src="theme/img/client/client-4.png" alt="#"></a>
								</div>
							</div>
							<!--/ End Single client -->
							<!-- Single client -->
							<div class="single-slider">
								<div class="single-client">
									<a href="#" target="_blank"><img src="theme/img/client/client-5.png" alt="#"></a>
								</div>
							</div>
							<!--/ End Single client -->
							<!-- Single client -->
							<div class="single-slider">
								<div class="single-client">
									<a href="#" target="_blank"><img src="theme/img/client/client-6.png" alt="#"></a>
								</div>
							</div>
							<!--/ End Single client -->
						</div>
		...
		<!-- Footer -->
		<footer class="footer" style="background-image:url('theme/img/map.png')">
			<!-- Footer Top -->
								...
								<div class="logo">
									<div class="img-logo">
										<a class="logo" href="index.html">
											<img class="img-responsive" src="theme/img/logo2.png" alt="logo">
										</a>
									</div>
								</div>
